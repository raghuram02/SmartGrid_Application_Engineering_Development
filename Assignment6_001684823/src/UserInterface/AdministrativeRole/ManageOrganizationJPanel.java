...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(addJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 240, -1, -1));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 180, 81, -1));
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        Type type = (Organization.Type) organizationJComboBox.getSelectedItem();
        Organization organization = organizationDirectory.createOrganization(type);
        if (type == Nurse) {
            organization.getSupportedRole().add(new NurseRole());
        } else if (type == Receptionist) {
            organization.getSupportedRole().add(new ReceptionistRole());
        }
        else if (type == Donor) {
            organization.getSupportedRole().add(new DonorRole());
        }
