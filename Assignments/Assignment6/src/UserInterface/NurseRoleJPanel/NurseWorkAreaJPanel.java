...
public class NurseWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 375, 96));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 26, -1, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, -1, -1));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            BloodDonationWorkRequest request = (BloodDonationWorkRequest) workRequestJTable.getValueAt(selectedRow, 0);
