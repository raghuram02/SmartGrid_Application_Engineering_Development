...
//        this.appliance = appliance;
    ...
    private void initComponents() {
        ...
        add(viewDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 110, 110, 40));
...
//            p.setPhoneNumber(Integer.parseInt(txtPhone.getText()));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int selectedRow = applianceTbl.getSelectedRow();
        if (selectedRow < 0) {
            JOptionPane.showMessageDialog(null, "Please select Appliance from the table!!!", "Information", JOptionPane.INFORMATION_MESSAGE);
        } else {
