 ...
 * @author Raghuram
 */
public class AddAppliancesWorkRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public AddAppliancesWorkRequestJPanel(JPanel userProcessContainer, UserAccount account, 
            Organization organization, Enterprise enterprise, Appliance appliance, Person person) {
        initComponents();
        this.person = person;
        ...
        System.out.println("person inside add appliances"+person);
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ADD APPLIANCES WORK REQUEST");
        jLabel3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, -1, -1));
...
int selectedRow = workRequestJTable.getSelectedRow();
        ...
        if (selectedRow >= 0) {
             AddAppliancesWorkRequest request = (AddAppliancesWorkRequest) workRequestJTable.getValueAt(selectedRow, 0);

            request.setStatus("Processing");

            InputAppliancesJPanel inputAppliancesJPanel = new InputAppliancesJPanel(userProcessContainer, request,appliance,person);
            userProcessContainer.add("inputAppliancesJPanel", inputAppliancesJPanel);
