 ...
 * @author Raghuram
 */
public class MaintenanceUserSignupJPanel extends javax.swing.JPanel {
     ...
     */
    public MaintenanceUserSignupJPanel(JPanel userProcessContainer, PersonDirectory personDirectory, SmartGrid sg) {
        initComponents();
...
//                        System.out.println("org"+organization1);
                        if ((organization1 instanceof PublicOrganization)) {
//                            System.out.print("Organization"+organization1);
    ...
    private void populateComboBox() {
        ...
        for (Enterprise.EnterpriseType type : Enterprise.EnterpriseType.values()) {
            if (type.getValue().equals(Enterprise.EnterpriseType.GovernmentOwned.getValue())) {
                ...
                for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                    if (enterprise instanceof GovernmentOwnedEnterprise) {
                        for (Organization org : enterprise.getOrganizationDirectory().getOrganizationList()) {
                            if (org instanceof PublicOrganization) {
                                organization = org;
                            }
                        }
                    }
